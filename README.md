...
- 🔭 I build projects that span data, web, and systems: Python & Jupyter for data experiments, HTML/CSS/JavaScript for front-end work, and C / C++ / C# / Java / Kotlin for systems and applications build.
...
- [GAME](https://github.com/AmanPr0f/GAME) — Python games and interactive experiments.
